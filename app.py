...
def create():
    # determine if the page is being requested with POST or GET request
    if request.method == 'POST':
        # get the title that was submitted 
        title = request.form['title']
        content = request.form['content']

        # display an error message if content or title is not submitted
...
def edit(id):
    # get the post from the db with a select query for the that post id 
    post = get_post(id)
